...
description: 'An in-depth look at how to use Tailwind CSS with Angular in an Nx monorepo.'
date: 'January 28, 2022'
heroImage: '/assets/blog/set-up-tailwind-css-with-angular-in-an-nx-workspace/hero.png'
heroImageAlt: 'Nx, Angular, and Tailwind CSS logos'
thumbnailImage: '/assets/blog/set-up-tailwind-css-with-angular-in-an-nx-workspace/thumbnail.png'
thumbnailImageAlt: 'Nx, Angular, and Tailwind CSS logos'
canonicalUrl: 'https://blog.nrwl.io/set-up-tailwind-css-with-angular-in-an-nx-workspace-6f039a0f4479'
---
...
![Applications mockup](https://cdn-images-1.medium.com/max/2030/1*OXo64rzyF-5nKO2fbpG4xg.png)
...
![Application 1 screenshot](https://cdn-images-1.medium.com/max/8128/1*TkIVfzbeier6j0nlAeX7ig.png)
...
![Decision tree for the need of Tailwind CSS configuration in Angular libraries](https://cdn-images-1.medium.com/max/2000/1*x_nZUiADymUMNsmDpAU3aA.png)
...
![Project graph showing dependencies between the projects in the workspace](https://cdn-images-1.medium.com/max/2000/1*F1p0OfL4WrmubTQ2QPX04Q.png)
...
![Application 2 screenshot](https://cdn-images-1.medium.com/max/8128/1*LoOmmjSzfB33ho9NhcqQKQ.png)
...
![Application 2 screenshot](https://cdn-images-1.medium.com/max/8128/1*TwcAfPTrKRm1D9ydEFwWWA.png)
...
![Publishable library with the produced theme files highlighted](https://cdn-images-1.medium.com/max/2000/1*vcHqTWEppPbVtGRlVIqEPg.png)
